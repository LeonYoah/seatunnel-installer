# SeaTunnel 一键安装指南
注：本人能力有限，本项目采用 AI 辅助开发（Vibe Coding）模式构建。代码质量和功能实现可能存在改进空间，欢迎提交 Issue 和 PR 共同完善。
**免责声明**：使用本项目产生的任何问题，AI 和人类将共同承担责任（比例待商榷）😄
## 什么是 SeaTunnel
...
- 支持debug模式，一键预览seatunnel的source产生的数据
...
- 灵活性二次开发：支持在线二次开发 打包 推送镜像，适用于企业内部快速定制化和bug修复
